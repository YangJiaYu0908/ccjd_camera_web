...
public class SpringDocConfig {
    ...
    public GroupedOpenApi publicApi() {
        return GroupedOpenApi.builder()
                .group("1. 全部")
                .packagesToScan("com.ccjd.camera.vmanager")
                .build();
    }
    ...
    public GroupedOpenApi publicApi2() {
        return GroupedOpenApi.builder()
                .group("2. 国标28181")
                .packagesToScan("com.ccjd.camera.vmanager.gb28181")
                .build();
    }
    ...
    public GroupedOpenApi publicApi3() {
        return GroupedOpenApi.builder()
                .group("3. 拉流转发")
                .packagesToScan("com.ccjd.camera.vmanager.streamProxy")
                .build();
    }
    ...
    public GroupedOpenApi publicApi4() {
        return GroupedOpenApi.builder()
                .group("4. 推流管理")
                .packagesToScan("com.ccjd.camera.vmanager.streamPush")
                .build();
    }
    ...
    public GroupedOpenApi publicApi5() {
        return GroupedOpenApi.builder()
                .group("4. 服务管理")
                .packagesToScan("com.ccjd.camera.vmanager.server")
                .build();
    }
    ...
    public GroupedOpenApi publicApi6() {
        return GroupedOpenApi.builder()
                .group("5. 用户管理")
                .packagesToScan("com.ccjd.camera.vmanager.user")
                .build();
    }
}
