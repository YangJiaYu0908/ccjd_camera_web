package com.ccjd.camera.gb28181.conf;

import com.ccjd.camera.gb28181.transmit.event.request.impl.message.notify.cmd.AlarmNotifyMessageHandler;
...
//        properties.setProperty("gov.nist.javax.sip.MESSAGE_PROCESSOR_FACTORY", "gov.nist.javax.sip.stack.NioMessageProcessorFactory");
        ...
        if (sipLog) {
            properties.setProperty("gov.nist.javax.sip.STACK_LOGGER", "com.ccjd.camera.gb28181.conf.StackLoggerImpl");
            properties.setProperty("gov.nist.javax.sip.SERVER_LOGGER", "com.ccjd.camera.gb28181.conf.ServerLoggerImpl");
